...
| 25/05   | Gantt V1    |  link:gantt_v1/ptut_v1.pdf[PDF]   | Tout semble OK (mais je ne suis pas un spécialiste de Gantt)...
| 26/05   | CdC V1      |  link:Diagrammes/CreerClient/CahierDesCharges.pdf[PDF]|          
|         | Gantt V1-2  |                 |      
| 27/05   | CdC V1 final |                     | 
|         | Gantt V1-3  |    |
| 28/05   | CdC V2 final |    |
