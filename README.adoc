...
| 25/05   | Gantt V1    |  link:gantt/V1/ptut_v1.pdf[PDF]      | Tout semble OK (mais je ne suis pas un spécialiste de Gantt)...
| 26/05   | CdC V1      |  link:Diagrammes/CDC_V1.pdf[PDF]|          
|         | Gantt V1-2  |  link:gantt/V1/ptut_v1-2.pdf[PDF]    |      
| 27/05   | CdC V1 final | link:Diagrammes/CDC_V1_final.pdf[PDF]                    | 
|         | Gantt V1-3  | link:gantt/V1/ptut_v1-3.pdf[PDF]   |
| 28/05   | CdC V2 final |link:Diagrammes/CDV_V2_Final.pdf[PDF]   |
|         | Gantt V2    | link:gantt/V2/ptut_v2.pdf[PDF]         |             
|         | Doc. Util. V1 |link:Documentations/doc_utilisateur/doc_utilisateur_V1.pdf[PDF]              |          
|         | Doc. Tec. V1 |link:doc/docTechnique.adoc[ADOC]                   |    
|         | Code V1     |                       |
|         | Recette V1  | link:Documentations/cahier_de_recettes_v1.pdf[PDF]                      |
|         | `jar` projet |    |
| 31/05   | Gantt V2-1    | link:/gantt/V2/ptut_v2-1.pdf[PDF]      |
| 01/06   | Doc. Util. V2 |            |           
|         | Doc. Tec. V2 |                  |     
|         | Code V2     |                       |
|         | Recette V2  |                       |
