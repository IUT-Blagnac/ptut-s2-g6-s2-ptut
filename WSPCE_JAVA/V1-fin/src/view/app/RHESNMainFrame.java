...
public class RHESNMainFrame extends JFrame {
    ...
    public RHESNMainFrame(Employe pfEmploye){
        ...
        employeButton = new JButton("Employe");
        ...
        employeLabel = new JLabel("<html><u>Employe connecte(e) :</u><br><br>Nom: <i>"+employeUtilisateur.getNom()+ "</i><br>Prenom: <i>"+ employeUtilisateur.getPrenom()+"</i><br>Role: <i>"+ libRole+"</i></html>\n");
