...
public class EmployeEditor extends JDialog {
	...
	private EmployeEditor(Employe pfEmployeEdite, Employe pfEmployeUtilisateur, Window owner, EmployeEditor.ModeEdition pfMode) {
        ...
        idText = new JTextField("Genere automatiquement");
        ...
        employeBouton = new JRadioButton("Employe");
    ...
    private void changeEtatSaisie() {
		switch (modeActuel) {
			case CREATION :
			    ...
			    titreLabel.setText("Creer Employe");
			...
			case MODIFICATION:
			    ...
			    titreLabel.setText("Modifier Employe");
			...
			case VISUALISATION:
			    ...
			    titreLabel.setText("Voir Employe");
