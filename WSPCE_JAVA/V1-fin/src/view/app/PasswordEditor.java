...
public class PasswordEditor extends JDialog {
	...
	private PasswordEditor(Window owner, String loginUSer, PasswordEditor.ModeEdition mode) {
        ...
        TitledBorder title = BorderFactory.createTitledBorder(
                blackline, "Veuillez saisir un MOT DE PASSE VALIDE sur votre systeme",
        ...
        // Titre label
        titreLabel = new JLabel("Creer mot de passe");
        ...
        // Boutons
        enregistrerBouton = new JButton("Creer MP");
        if (modeActuel == PasswordEditor.ModeEdition.MODIFICATION) {
    ...
    private void actionOK() {
    	...
    	if (mdp.contains(" ") || mdp.contains("\t") || mdp.contains("\n") || mdp.contains("\b")) {
    		JOptionPane.showMessageDialog(this, "Ne pas saisir de caractere(s) invalide(s)", "ERREUR", JOptionPane.ERROR_MESSAGE);
    		mdpText.setText("");
    		reMDPText.setText("");
    		return ;
    	}
    	if (mdp.compareTo(reMDP) != 0) {
    		JOptionPane.showMessageDialog(this, "Saisir deux fois le meme mot de passe", "ERREUR", JOptionPane.ERROR_MESSAGE);
    		mdpText.setText("");
    		reMDPText.setText("");
    		return ;
    	}
